    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="" action="update_profesores1.php" method="post">
              <label>Nombre: </label> <input type="text" name="nombre" id="nombre"><br><br>
              <label>Apellidos: </label> <input type="text" name="apellidos" id="apellidos"><br><br>
              <label>¿Qué atributo quieres cambiar?</label><br>

              <select name="atributo" id="atributo" name="atributo">
                <option value="DNI">DNI</option>
                <option value="Nombre">Nombre</option>
                <option value="Apellidos">Apellidos</option>
                <option value="Fecha_de_nacimiento">Fecha de nacimiento</option>
                <option value="Numero_de_horas">Numero de horas</option>
                <option value="Cod_Departamento">Código Departamento</option>
                <option value="usuario">Usuario</option>
                <option value="contrasena">Contraseña</option>
              </select><br><br>

              <label>Nuevo valor del atributo: </label><input type="text" name="valorNuevo" id="valorNuevo"><br>
