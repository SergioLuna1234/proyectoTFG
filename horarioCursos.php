...
<head>
  ...
  <link  href="css/miCss.css" rel="stylesheet" type="text/css">
    <link  href="css/cssFernando.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1>Horario de cursos</h1>
          <br>
          <h5>Seleccionar la linea y el nombre del curso que desea buscar:</h5>
          <br>
          <div>
      <!--FORMULARIO PARA ENVIAR EL NUMERO DE CURSO Y NOMBRE PARA INTRODUCIR SU HORARIO EN LA TABLA -->
      <form action="horarioFernando/horarioCursos.php" method="post">
      <select id="ncurso" name="ncurso" onchange="buscar()" class="miSelect">
        <option value="0">Seleccionar</option>
        <option value="1">1º</option>
        <option value="2">2º</option>
      </select>
      <select id="nombrecurso" name="nombrecurso" onchange="buscar()" class="miSelect">
        <option value="Seleccionar">Seleccionar</option>
      <?php
      
        $sqlN = "SELECT distinct Nombre from cursos";
        $resultadoN = mysqli_query($conn,$sqlN);
        if (mysqli_num_rows($resultadoN)>0)
        {
          while($fila=mysqli_fetch_assoc($resultadoN))
          {
    ...
    <script>
    function buscar() {
        var num = document.getElementById("ncurso").value;
        var nombrec = document.getElementById("nombrecurso").value;
       
        if(num>0 && nombrec!=="Seleccionar"){
        var str = num+" "+nombrec;
            ...
            xmlhttp.open("GET", "horarioFernando/busquedaCursos.php?q=" + str, true);
            xmlhttp.send();
        }
    }
</script>
