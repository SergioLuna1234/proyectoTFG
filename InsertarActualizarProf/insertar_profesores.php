    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
              ...
              $password = "";
              $conn = mysqli_connect($servidor, $usuario, $password, "movedb");
              if (!$conn) {
               die("Conexion fallida: " . mysqli_connect_error());
              }

              //$sql = "INSERT INTO profesores ('Id', 'DNI', 'Nombre', 'Apellidos', 'Fecha_de_nacimiento', 'Numero_de_horas', 'Cod_Departamento') VALUES ($_POST['id'], $_POST['dni'], $_POST['nombre'], $_POST['apellidos'],
                //                                                                                                  $_POST['fnacimiento'], $_POST['nhoras'], $_POST['departamento'])";
                  if (isset($_POST['id'])) {
                       $id = $_POST['id'];
                  }
                  if (isset($_POST['dni'])) {
                ...
                $sql = "INSERT INTO profesores (Id, DNI, Nombre, Apellidos, Fecha_de_nacimiento, Numero_de_horas, Cod_Departamento)"."VALUES ('$id', '$dni', '$nombre', '$apellidos', '$fnacimiento', '$nhoras', '$departamento')";
