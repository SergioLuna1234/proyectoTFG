    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                    ...
                    $sqldni = "SELECT `Id` FROM `profesores` WHERE `Nombre` = '$nombre' AND `Apellidos` = '$apellidos'";
                    ...
                    $sql = "UPDATE profesores SET $atributo = '$valor' WHERE Id = $id";
