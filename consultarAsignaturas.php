...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <form action="busquedaAsignatura.php" method="post">
      <select id="idCurso" name="nombrecurso" onchange="buscar()" class="miSelect">
    ...
    function buscar() {
       ...
       if (window.XMLHttpRequest) {
            ...
            xmlhttp.open("GET", "busquedaAsignaturas.php?respuesta=" + curso, true);
            xmlhttp.send();
