    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
            <a href="insertar_profesores.php" class="opcion"><i class="fas fa-plus"></i> Insertar profesor</a>
            <a href="update_profesores.php" class="opcion"><i class="far fa-edit"></i> Actualizar profesor</a>
