        ...
        <div class="container-fluid">
          <!-- CONTENIDO DE LA PAGINA -->
            ...
            if($_SESSION["nombre_usuario"]["name"]==="admin" || $_SESSION["nombre_usuario"]["name"]==="jefedeestudios")
            {
                ...
                $sql = 'SELECT PROFESORES.Nombre AS Nombre, PROFESORES.Apellidos FROM PROFESORES INNER JOIN CARGOS ON PROFESORES.Id = CARGOS.Cod_profesor WHERE CARGOS.Nombre="'.$usuario.'"';
                ...
                if ($resultado->num_rows > 0) 
                {
                    ...
                    echo "<h1> Bienvenido/a ".$fila['Nombre']." ".$fila['Apellidos']." (".$usuario.")</h1>";
                    }
            ...
            else
            {
                ...
                if ($resultado->num_rows > 0) 
                {
                    ...
                    while ($fila=$resultado->fetch_assoc()) 
                    {
                    echo "<h1> Bienvenido/a ".$fila['Nombre']." ".$fila['Apellidos']."</h1>";
                    }
                }
            }
            ?>
            ...
            <br>
            <h4>Para navegar utilice el navegador que esta a la izquierda de su pantalla.</h4>
