  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <form action="actualizarpwd1.php" method="post">
            <input type="text" placeholder="Usuario" name="nombre" class="nombre" required>
            <input type="password" placeholder="Contraseña" name="pass" class="pass" required minlength="8">
            <input type="password" placeholder="Contraseña" name="pass2" class="pass" required minlength="8">
