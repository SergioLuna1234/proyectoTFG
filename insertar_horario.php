      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- CONTENIDO DE LA PAGINA -->
            ...
            <br>
            <form action="insertar_horario_resultado.php" method="post">
        <div style="Display:inline; color:red;">Aula:
            <select name="AulaID" class="miSelect" required>
                <?php
            ...
            &nbsp;&nbsp;&nbsp;Dia:&nbsp;
            <select name="Dia" class="miSelect" required>
                <?php
            ...
            &nbsp;&nbsp;&nbsp;Hora:&nbsp;
            <select name="Hora" class="miSelect" required>
                <?php
            ...
            Curso:&nbsp;
            <select name="Curso" class="miSelect" onchange="CursoAsig(this.value)" required>
                <?php
            ...
            <script>
                ...
                document.getElementById("ProfAsig").innerHTML="";
                document.getElementById("ProfAsig").innerHTML=this.responseText;
                }
                }
                    
                    
                    
                xmlhttp.open("GET","busquedaAsigProfajax.php?respuesta="+IdCurso,true);
                xmlhttp.send();    
                }
            </script>
            </div>
            <div id="ProfAsig" style="Display:inline; color:red;"></div>
