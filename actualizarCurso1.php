...
<!-- HTML -->
<div class="container">
  <form action="actualizarCurso2.php" method="post">
            <table>
                <tr><th colspan="2" class="titulo"><h2>Curso que quieres editar</h2></th></tr>
                <tr><td class="combo">
                        <select name="numero">
                ...
                </tr><td colspan="2" class="tdboton">
                    <input type="submit" value="Buscar Curso" class="boton">
                </td>
                </tr>
