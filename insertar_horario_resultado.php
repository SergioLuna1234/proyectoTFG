        ...
        <div class="container-fluid">
          <!-- CONTENIDO DE LA PAGINA -->
           ...
           // echo $aulahora;
            ...
            $sqlinsertar ="INSERT INTO `rel_aula_hora_y_asig_cur`(`Cod_Hora_Aula`, `Cod_Prof_Asig`) VALUES (".$aulahora.",".$profAsig.")";
...
echo "<center><div>$tabla</div></center>";
                ...
                WHERE Rel_Prof_Asig.Id='.$profAsig;
