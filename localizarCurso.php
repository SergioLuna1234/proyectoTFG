...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="localizarCurso2.php" method="post">
           <center><table>
        <tr><th colspan="2">Datos del curso</th></tr>
        <tr>
        <td >Nombre del Curso</td>
        <td>
          <select name="datos" class="miSelect">
          <?php
        ...
        <tr>
    <td>Linea del Curso</td> 
    <td><select name="datosdos" class="miSelect">
    ...
    <option value="2">2º</option>
         ...
         <tr><center><td colspan="2"><input type="submit" value="Consultar"></td></center></tr>
              </table></center>
    
    </form>
    <a href="gestionarCursos.php" class="comeBack">Volver</a>
