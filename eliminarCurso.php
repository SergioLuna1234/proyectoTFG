      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="eliminarCurso.php" method="post">
                    <table>
                        <tr><th colspan="2"><h2>Curso a eliminar</h2></th></tr>
                        <tr><td>
                                <select name="numero">
                            ...
                            <input type="submit" value="Borrar Curso" class="boton">
                        </td>
                        </tr>
                ...
                <div class="respuesta">
                    ...
                    if ($numero!=0) {
                        ...
                        $estamento = $conn->prepare("DELETE FROM cursos WHERE Id= ?");

                        $estamento->bind_param("d", $id);
                        $estamento->execute();

                        if ($conn->affected_rows > 0)//te devuelve el numero de filas
                        {
                            echo "<br>Se ha eliminado el Curso $numero" . "º " . $nombre;
                        }
                    }
                    ?>
                </div>
