...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE `cursos` SET `Curso`='".$curso."',`Nombre`='".$nombre."',`Enseñana`= '".$ensenanza."',`Horario`= '".$horario."',`Delegado`= '".$delegado."',`Subdelegado`= '".$subdelegado."' WHERE `Id` = $id";
...
<div class="container">
        ...
        <form action="update.php" method="post" class="main-form">
            <div class="form-group">
            <label>ID a actualizar: </label>
            <input class="gt-input" type="text" name="id" required><br><br>
            </div>
            <div class="form-group">
            <label>Nuevo curso:</label>
            <input class="gt-input" type="text" name="curso" required><br><br>
            </div>
            <div class="form-group">
                <label>Nuevo nombre:</label>
            <input class="gt-input" type="text" name="nombre" required><br><br>
                </div>
            <div class="form-group">
                <label>Nueva enseñanza:</label>
            <input class="gt-input" type="text" name="ensenanza" required><br><br>
            </div>
            <div class="form-group">
                <label>Nuevo horario:</label>
            <input class="gt-input" type="text" name="hora" required><br><br>
            </div>
            <div class="form-group">
                <label>Nuevo Delegado:</label>
            <input class="gt-input" type="text" name="delegado" required><br><br>
            </div>
            <div class="form-group">
                <label>Nuevo Subdelegado:</label>
            <input class="gt-input" type="text" name="subdelegado" required><br><br>
            </div>
            <input type="submit" class="gt-button" name="update" value="Update Data">
