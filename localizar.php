...
<link  href="css/localizar.css" rel="stylesheet" type="text/css">
</head>
...
<body id="page-top">
  ...
  <?php
  // ESTA LINEA NOS ELIMINA LOS POSIBLES ERRORES DE LA PANTALLA
  error_reporting(0);
  
  include 'php/funcionFormateoHoras.php';
  include 'php/funcionRevertirFormateoHoras.php';
  ...
  echo "<br><input type='submit' name='submit' value='Buscar' class='buscar'>" ;
  // echo "<br><input type='submit' name='submit' value='Buscar ahora' class='buscar'>";
  ...
  $sql3 = "SELECT AULAS.Id as aulasID, CURSOS.Curso, CURSOS.Nombre AS Formacion, HORARIO.Dia, HORARIO.Hora, ASIGNATURA.Nombre_de_la_asignatura, PROFESORES.Nombre, PROFESORES.Apellidos, AULAS.Nombre AS aulasNombre
    ...
    if ($resultado->num_rows > 0) {
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            echo "<div class='resultado'>" . $nombreProfesor . " esta en " . $curso . "º de " . $nombreCurso . "</div>";
            echo "<img src='planos/".$fila['aulasID'].".png' alt=".$fila['aulasNombre']." width='400'>";
            // Este fragmento es por si queremos sacar el mensaje mediante un alert
            // echo"<script type='text/javascript'>
            // alert('$nombreProfesor esta en $curso º de $nombreCurso');
            // window.location.href='localizar.php';
            // </script>";
    }
    ...
    echo $profesorParam . " no tiene asignado ningun curso el " . $diaParam . " a las " . $horaParam;
