...
<body>
<form action="horarioProfesores.php" method=post name="busqueda">
<input type="hidden" id="ID" name="ID" value="valor">
</form> 
    <h1>Horario profesores:</h1>
<table>
<form>
<tr><th colspan="2">Escribe el profesor que quieras buscar:</th></tr>
<tr><td width="110">Nombre: </td><td width="205"><input type="text" width="204.8" name="profnom" id="profnom" onkeyUp="mostrarProf(this.value, 1)"></td></tr>
<tr><td width="110">Apellido: </td><td width="205"><input type="text" width="204.8" name="profape" id="profape" onkeyUp="mostrarProf(this.value, 2)"></td></tr>
<tr><td width="110">Departamento: </td>
<td width="205"><select name="profdep" id="profdep" height="32" onchange="mostrarProf(this.value, 3)">
    <option value=""></option>
<?php
