...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    if($idAsig!=""){
        ...
        $sqlasig="DELETE FROM asignatura WHERE asignatura.Id=".$idAsig;
        $sqlRel="DELETE  FROM Rel_Prof_Asig WHERE Rel_Prof_Asig.Cod_Asig=".$idAsig;
        
         if ($conn->query($sqlasig) === TRUE) {
    if ($conn->query($sqlRel) === TRUE) {
        
        echo "Se acaba de eliminar la  asignatura.";
        } else {
     echo "Se acaba de eliminar la  asignatura.";
    }
         }
        else {
     echo "No se ha podido eliminars la asignatura.";
        }
...
<?php
    ...
    if ($conn->query($sqlRel) === TRUE) {
        ...
        echo "<script> alert('Se acaba de eliminar la  asignatura.');</script>";
        } else {
     echo "<script> alert('$idAsig');</script>";
    }
         }
        else {
     echo "<script> alert('No se ha podido eliminars la asignatura.');</script>";
        }
