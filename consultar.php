...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      $nombrecur=$_REQUEST["datos"];
      $anocur=$_REQUEST["datosdos"];
      
      // 2) Preparar la orden SQL
      $consulta="SELECT * FROM `cursos` WHERE `Nombre` =  '$nombrecur' AND `Curso` = '$anocur'";

      // 3) Ejecutar la orden y obtener datos
      mysqli_select_db($conn,"movedb");
      $datos= mysqli_query($conn,$consulta);
      echo "<h1>Datos del Curso:</h1>";
      echo "<table border='1'>";
      echo "<tr><th>ID</th><th>NOMBRE</th><th>ENSEÑANZA</th><th>HORARIO</th><th>DELEGADO</th><th>SUBDELEGADO</th><th>AULA</th><th>TUTOR</th></tr>";
      echo "<br>";
      ...
      echo "</td>"; // un separador
      echo "<td>"; // un separador
      echo $fila ["Subdelegado"];
      echo "</td>"; // un separador
      echo "<td>"; // un separador
      echo $fila ["Aula_Principal"];
      echo "</td>"; // un separador
      echo "<td>"; // un separador
      echo $fila ["Tutor"];
      echo "</td>"; // un separador
      ...
      <a href="datosCurso.php" class="comeBack">Volver</a>
