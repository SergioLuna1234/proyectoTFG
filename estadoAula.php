...
<head>
  ...
  <link  href="css/miCss.css" rel="stylesheet" type="text/css">
    <link href="victor/estilo.css" rel="stylesheet" type="text/css">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="victor/estadoAulaServidor.php" method="post">
        <p>Aula:
            <select name="AulaID" class="miSelect">
                <?php
            ...
            &nbsp;&nbsp;&nbsp;Dia:&nbsp;
            <select name="Dia" class="miSelect">
                <?php
            ...
            &nbsp;&nbsp;&nbsp;Hora:&nbsp;
            <select name="Hora" class="miSelect">
                <?php
                ...
                if ($resultado->num_rows > 0) { //SI CONTIENE ALGUN RESULTADO...
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        $hora = $fila['Hora'];
                        echo "<option>" . formateo($hora) . "</option>";
                    }
                }
                $resultado->free();
            ...
            Asignatura:&nbsp;
            <select name="Asignatura" class="miSelect">
                <?php
                
                $sql = "SELECT DISTINCT Nombre_de_la_asignatura FROM ASIGNATURA";
                $resultado = $conn->query($sql);
                if ($resultado->num_rows > 0) { //SI CONTIENE ALGUN RESULTADO...
                    echo "<option>TODAS</option>";
                    while ($fila = $resultado->fetch_assoc()) {
                        $asignatura = $fila['Nombre_de_la_asignatura'];
                        echo $asignatura;
            ...
            &nbsp;&nbsp;&nbsp;Profesor:&nbsp;
            <select name="Profesor" class="miSelect">
                <?php
                
                $sql = "SELECT Nombre, Apellidos FROM PROFESORES";
                $resultado = $conn->query($sql);
                if ($resultado->num_rows > 0) { //SI CONTIENE ALGUN RESULTADO...
                    echo "<option>TODOS</option>";
                    while ($fila = $resultado->fetch_assoc()) {
                        $profesor = $fila['Apellidos'] . "," . $fila['Nombre'];
