  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <br>
          <h5>Busque las asignaturas de los cursos:</h5>
          <br>
          <div style="color:red;">
      <!--FORMULARIO PARA ENVIAR EL NUMERO DE CURSO Y NOMBRE PARA INTRODUCIR SU HORARIO EN LA TABLA -->
      <form action="eliminar_asignatura2.php" method="post">
      Curso: <select id="idCurso" name="nombrecurso" onchange="buscar()" class="miSelect">
        <option value="Seleccionar">Seleccionar</option>
      <?php
        
        $sqlN = "SELECT * from cursos";
        $resultadoN = mysqli_query($conn,$sqlN);
        if (mysqli_num_rows($resultadoN)>0)
        {
          while($fila=mysqli_fetch_assoc($resultadoN))
          {
            echo "<option value='".$fila['Id']."'>".$fila['Curso']."º ".$fila['Nombre']."</option>";
          }
        }
       ?>
       </select>
          <div id="contenedor" style="Display:inline;"></div>
    ...
    function buscar() {
       ...
       if (window.XMLHttpRequest) {
            ...
            xmlhttp.open("GET", "busquedaAsignaturasEliminar.php?respuesta=" + curso, true);
            xmlhttp.send();
