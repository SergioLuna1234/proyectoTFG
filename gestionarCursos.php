...
<head>
  ...
  <link  href="css/miCss.css" rel="stylesheet" type="text/css">
    <link  href="css/gestionarCursos.css" rel="stylesheet" type="text/css">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            if($_SESSION["nombre_usuario"]["name"]==="admin" || $_SESSION["nombre_usuario"]["name"]==="jefedeestudios")
            {
            echo '<a href="eliminarCurso.php" class="opcion"><i class="fas fa-eraser"></i>  Eliminar curso</a>';
            echo '<a href="actualizarCurso1.php" class="opcion"><i class="far fa-edit"></i> Actualizar curso</a>';
            echo '<a href="insertarCurso.php" class="opcion"><i class="fas fa-plus"></i> Insertar curso</a>';
            }
            ?>
            <a href="datosCurso.php" class="opcion"><i class="fas fa-dice-d6"></i> Datos cursos</a>
            <a href="localizarCurso.php" class="opcion"><i class="fas fa-map-marker-alt"></i> Localizar curso</a>
        </div>
        <!-- /.container-fluid -->
