    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          $consulta="SELECT Aula_Principal FROM `CURSOS` WHERE `Nombre` =  '$nombrecur' AND `Curso` = '$anocur'";
          ...
          $resultado =  $row['Aula_Principal'];

          mysqli_close($conn);
          ?>

<h1>Aquí se encuentra normalmente su curso:</h1>
        
<img src="planos/<?php echo $resultado; ?>.png" class="plano">
