...
<head>
  ...
  <!-- ESTILO DE FERNANDO PORQUE ES UN TONTO -->
  <style>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          //echo "$id $curso $nombre $ensenanza $horario $delegado $subdelegado $aula $profesor";

          if ($curso ==""&& $nombre ==""&& $ensenanza ==""&& $horario ==""&& $delegado ==""&& $subdelegado ==""&& $aula ==""&& $profesor =="")
          {
            echo "No se ha actualizado ningún datos del Curso";
          }
          else {
            ...
            if ($curso !="")
            {
              $sqlUpdate = $sqlUpdate."Curso=$curso, ";
            }
            ...
            if ($ensenanza !="")
            {
              $sqlUpdate = $sqlUpdate."Enseñana='$ensenanza', ";
            }

            if ($horario !="")
            {
              $sqlUpdate = $sqlUpdate."Horario='$horario', ";
            }

            if ($delegado !="")
            {
              $sqlUpdate = $sqlUpdate."Delegado='$delegado', ";
            }

            if ($subdelegado !="")
            {
              $sqlUpdate = $sqlUpdate."Subdelegado='$subdelegado', ";
            }

            if ($aula !="")
            {
              $sqlUpdate = $sqlUpdate."Aula_Principal=$aula, ";
            }

            if ($profesor !="")
            {
              $sqlUpdate = $sqlUpdate."Tutor=$profesor, ";
            }
...
<a href="actualizarCurso1.php" class="volver">Actualizar otro curso</a>
        </div>
        <!-- /.container-fluid -->
