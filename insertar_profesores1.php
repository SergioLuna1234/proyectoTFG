      ...
      <div id="content">
        ...
        <div class="container-fluid">
              <?php
                  ...
                  if (isset($_POST['id'])) { // si existe el atributo id en el html
                       $id = $_POST['id']; // coge su valor y asignalo a esta variable
                  }
                  if (isset($_POST['dni'])) {
                      $dni = $_POST['dni'];
                  }
                ...
                $sql = "INSERT INTO profesores (Id, DNI, Nombre, Apellidos, Fecha_de_nacimiento, Numero_de_horas, Cod_Departamento, usuario)"."VALUES ('$id', '$dni', '$nombre', '$apellidos', '$fnacimiento', '$nhoras', '$departamento', '$user' )";
                // creamos la orden sql que queremos que se cree, en este caso, un insertar

              if (mysqli_query($conn, $sql)) { // si se ejecuta correctamente
                    echo "Insertando profesor";
              } else { //si no
            ...
            <a href="actualizarpwd.php">Contraseña</a>
            </div>
            <!-- /.container-fluid -->
