...
<div class="box">
      ...
      if($curso!=""){
          ...
          if ($nombre=="")
          {
            echo "<div class='rojo'>El nombre del curso es un campo obligatorio</div>";
          }
          else
          {

            $sqlid = "SELECT MAX(Id) as maximo from cursos";
            ...
            $sqlinsertar = "INSERT INTO cursos (Id,Curso,Nombre,Enseñana,Horario,Delegado,Subdelegado,Aula_Principal,Tutor) VALUES
             ($id,$curso,'$nombre','$ensenanza','$horario','$delegado','$subdelegado',$aula,$profesor)";

             if(mysqli_query($conn, $sqlinsertar)){
                 echo "Curso creado.";
             }
             else {
                 echo "<div class='rojo'>ERROR: No se creo el curso. " . mysqli_error($conn)."</div>";
             }
        ...
        <a href="insertarCurso.php" class="volver">Crear otro curso</a>
