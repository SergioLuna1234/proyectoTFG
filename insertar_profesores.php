    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h2>Insertar profesores</h2>

            <form action="insertar_profesores1.php" method="post">
              <label>ID:</label><br>
              ...
              <input type="text" id="fnacimiento" name="fnacimiento"><br>
              <label>Numero de horas:</label><br>
              <input type="number" id="nhoras" name="nhoras"><br>
